...
- [voicechat](https://github.com/henkelmax/simple-voice-chat) pour parler en vocal en jeu. Nécessite d'avoir installé le mode [Simple-voice-chat](https://hangar.papermc.io/henkelmax/SimpleVoiceChat/versions/bukkit-2.5.12) sur votre jeu.
